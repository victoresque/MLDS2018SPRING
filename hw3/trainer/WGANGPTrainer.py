...
class WGANGPTrainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (real_images, ) in enumerate(self.data_loader):
            ...
            fake_labels = -torch.ones(self.batch_size)
            ...
            input_noise, real_labels, fake_labels, real_images = \
                to_variable(self.with_cuda, input_noise, real_labels, fake_labels, real_images)
            ...
            real_loss = wasserstein_loss(real_critic, real_labels)
            fake_loss = wasserstein_loss(fake_critic, fake_labels)
